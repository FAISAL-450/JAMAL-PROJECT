...
from .models import CustomerdetailedProfile, CustomerDetailed
...
# D - CustomerdetailedProfile Admin
@admin.register(CustomerdetailedProfile)
class CustomerdetailedProfileAdmin(AzureAdminOnlyMixin, admin.ModelAdmin):
