...
from .models import Pr, Project, Resource
...
class PrForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'requisition_date_pr': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'requisition_no': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter requisition number'}),
            'resource_name_pr': forms.Select(attrs={'class': 'form-control', 'placeholder': 'Enter resource'}),
            'resource_unit_pr': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Auto-fill unit'}),
            'quantity_pr': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Enter quantity'}),
            'delivery_date_pr': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
